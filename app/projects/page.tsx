export default function ProjectsPage() {
  ...
  return (
    <section>
      ...
      <h3 className="font-semibold text-md text-green-800 mb-2">Questions Generated & Issues Found:</h3>
      <ul className="list-disc ml-8 mb-4">
        <li>Question: Does this thinking extrapolate from goals into a meta-goal or optimization function? For example, would you simply tell your team of agents to maximize profits within the bounds of the law.</li>
        <li>Issue: The internet is a bit of a walled garden. If you're trying to find emails on the internet and use them in an email autonomously, what's the cleanest most reliable way to do that?</li>
        <li>Question: Is the goal-task paradigm the right one to manage ongoing workflows, or are threaded conversations like slack better for organizing ongoing work? As a slack user, I hope that's not the case :)</li>
      </ul>
      ...
      <h3 className="font-semibold text-md text-green-800 mb-2">Questions Generated & Issues Found:</h3>
      <ul className="list-disc ml-8 mb-4">
        <li>Issue: The technical problem of comparing every user to each other is an N^2 problem - so exploring an efficient use of semantic search with embeddings with a combination of decision tree may get you 90% of the way there. Then you can use the LLM for the "last mile" of matching.</li>
        <li>Issue: Testing network effect products require some patient users :)</li>
        <li>Question: Is chatting with an AI actually the best form of user input? Or does it live as perhaps an email client that is passively listening to your messages, and is aware of your existing social network.</li>
      </ul>
    </section>
  )
} 